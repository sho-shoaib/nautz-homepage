  ...
  return (
    <div ref={ref1}>
      <Box
        ...
        id='roadmap'
        maxWidth={"lg"}
        className='m-auto px-5 pb-44 pt-20'
      >
              ...
              <TimelineItem>
                ...
                <TimelineContent className='mb-16'>
                  <div className='glass p-5 rounded-lg'>
                    ...
                    We will open our community chats on discord We start out
                    post-launch marketing and introduce our collaborations !!
                  </div>
                </TimelineContent>
              </TimelineItem>
              <TimelineItem>
                ...
                <TimelineContent className='flex justify-end mb-16'>
                  <div className='glass p-5 rounded-lg'>
                    ...
                    holders! Our top 25 holders will be airdropped a Legendary
                    Dragon for free, owning that would make you an elite member
                    of our club!
                  </div>
                </TimelineContent>
              </TimelineItem>
              <TimelineItem>
                ...
                <TimelineContent className='mb-16'>
                  <div className='glass p-5 rounded-lg'>
                    ...
                    We give away $500 to 10 of our lucky holders and giveaway 5
                    NFTs to our most supportive Dragon community members🐉🐉
                  </div>
                </TimelineContent>
              </TimelineItem>
              <TimelineItem>
                ...
                <TimelineContent className='flex justify-end'>
                  <div className='glass p-5 rounded-lg'>
                    ...
                    celebrating our success with our investors and Dragon
                    holders🐉 We will be reserving Legendary Dragons for
                    auction, collabs and marketing purposes.
                  </div>
                </TimelineContent>
              </TimelineItem>
            </Timeline>
